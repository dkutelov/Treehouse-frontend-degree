...
function projectDescriptionHtml(e,a){for(var i="",l=0;l<5;l++){var s=a+l;i+='<div class="overlay__info-text-row-container">',i+='<p class="overlay__info-text overlay__info-text-line'+(l+1)+'">',i+=projects[e].description[s],i+="</p></div>"}return i}function showProject(e){var a=projects[e].skills,i=skillsHTML(a);$overlay.append($responsiveLabel,$overlayMainImage,$overlayInfoBlock),$(".overlay__main-image").append($mainImage),$(".overlay__main-image img").attr("src",projects[e].imageLargeUrl),$(".overlay__info").append($projectName,$projectSubheading,$descriptionContent,$projectSkills),$(".overlay__info-heading").text(projects[e].name);for(var l=0,s=0;s<3;s++){var o=projectDescriptionHtml(e,l);$(".desc-content").html(o).delay(3e3).queue(function(){$(this).find("p").addClass("overlay__info-text-line-disappear")}),l+=5}$(".overlay__info-skills").html(i);var a="all"}var projects=[{name:"Web API - Spotify Music Album Search",imageLargeUrl:"dist/img/projects/music-search-large.jpg",imageSmallUrl:"",description:["The project uses Spotify public APIs and","AJAX requests to create listing of music","albums of a favoire artist. Sorting of","albums by year, popularity and name was","added by employing JavaScript.","A list with all tracks and sample 30sec","play of each track are popping up on","click of each album as well as relevant","photos from Flickr are pooled with second","AJAX request and displayed. JavaScript","and jQuery navigation allows you to move","in the pop up window to the next or","previuos album. The web site uses","reposnsive CSS design for mobile, tablet","and desktop sreen sizes."],skills:[0,1,2,3]},{name:"Web Api - Spotify Music Album Search",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]}],$overlay=$(".overlay"),$overlaySkills='<div class="overlay__info-skills"></div>',$overlayMainImage='<div class="overlay__main-image"></div>',$responsiveLabel='<div class="reposiveLabel"><span>Responsive</span></div>',$overlayInfoBlock='<div class="overlay__info"></div>',$projectName='<h1 class="overlay__info-heading"></h1>',$mainImage="<img>",$projectSubheading='<h2 class="overlay__info-subheading">Project Description:</h2>',$projectSkills='<h2 class="overlay__info-subheading">Tech Skills:</h2><div class="overlay__info-skills"></div>',$descriptionContent='<div class="desc-content"></div>';
