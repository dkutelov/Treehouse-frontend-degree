...
function skillsHTML(s){var o="";if("all"==s)for(var e=0;e<skills.length;++e)o+='<div class="skills__outer-circle">',o+='<div class="skills__inner-circle">',o+='<div class="skills__icon '+skills[e].className+'"></div>',o+='<h4 class="skills__name">'+skills[e].name+"</h4></div></div>";return o}var skills=[{name:"HTML5",className:"icon-html",borderColor:"#4975FB"},{name:"JavaScript",className:"icon-js",borderColor:"#EF5252"},{name:"jQuery",className:"icon-jq",borderColor:"#EF5252"},{name:"Ajax",className:"icon-ajax",borderColor:"#EF5252"},{name:"Node.js",className:"icon-node",borderColor:"#EF5252"},{name:"SVG",className:"icon-svg",borderColor:"#939393"},{name:"CSS3",className:"icon-css",borderColor:"#ffd454"},{name:"Sass",className:"icon-sass",borderColor:"#ffd454"},{name:"PostCSS",className:"icon-postcss",borderColor:"#ffd454"},{name:"Git",className:"icon-git",borderColor:"#939393"},{name:"Gulp",className:"icon-gulp",borderColor:"#939393"},{name:"NPM",className:"icon-npm",borderColor:"#939393"}],skillsToShow="all";$(document).on("mousemove",".skills__outer-circle",function(s){var o=this.clientWidth,e=this.clientHeight,l=(s.offsetX-.5*o)/o*55,a=(1-(s.offsetY-.5*e))/e*55;$(this).css({transform:"perspective(300px) rotateX("+a+"deg) rotateY("+l+"deg)"})}),$(document).on("mouseout",".skills__outer-circle",function(s){$(this).css({transform:"perspective(300px) rotateX(0deg) rotateY(0deg)"})});
var projects=[{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"Web Api - Spotify Music Album Search",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]},{name:"",imageLargeUrl:"",imageSmallUrl:"",description:"",skills:[1,2,3]}];
